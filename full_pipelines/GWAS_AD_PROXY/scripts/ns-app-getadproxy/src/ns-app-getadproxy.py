...
def main(tabexport_with_icd):
    ...
    fig = ax.get_figure()
    fig.savefig('histo_phe_adbyproxy.png')
    ...
    #save
    local_outfname = 'ad_risk_by_proxy_wes.phe'
    ...
    dxpy.upload_local_file("histo_phe_adbyproxy.png", project=project_id, folder='/tmp')
